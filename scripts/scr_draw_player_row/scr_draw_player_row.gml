...
var width = 10 + name_width +
	...
	10 + string_width("0") +
	10 + string_width("00");
draw_rectangle_color(start_x, start_y, start_x + width, start_y + height, c_blue, c_blue, c_blue, c_blue, false);
...
draw_text(start_x + 5, start_y + 5, string(player.set_score));
